...
<button onClick={() => {
  if (showForm) {
    ...
    // open and clear the fields
    setFormData({ room_number: '', capacity: '', price: '', description: '', image_url: '' });
    setEditingRoom(null);
    setShowForm(true);
  }
}}>
